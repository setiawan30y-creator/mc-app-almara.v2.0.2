    ...
    reader.onload = async function(e) {
        try {
            ...
            jsonData.forEach((row, i) => {
                ...
                const idNasabah = getHeaderCell(row, ['ID_Nasabah', 'ID Nasabah', 'ID NASABAH', 'internal_id'], 0) !== undefined ? String(getHeaderCell(row, ['ID_Nasabah', 'ID Nasabah', 'ID NASABAH', 'internal_id'], 0)).trim() : null;
                const tipeLabel = getHeaderCell(row, ['Tipe', 'KN(TIPE)', 'KN Tipe', 'KN', 'customer_type'], 1) !== undefined ? String(getHeaderCell(row, ['Tipe', 'KN(TIPE)', 'KN Tipe', 'KN', 'customer_type'], 1)).trim() : '';
                const nama = getHeaderCell(row, ['Nama', 'Nama Lengkap', 'NAMA LENGKAP', 'name'], 2) !== undefined ? String(getHeaderCell(row, ['Nama', 'Nama Lengkap', 'NAMA LENGKAP', 'name'], 2)).trim() : null;
                ...
                let tglDaftarExcel = tglDaftarValue !== undefined ? String(tglDaftarValue).trim() : null;
