        ...
        tr.innerHTML = `
            ...
            <td style="text-align:center;">
                <div style="display:flex; gap:6px; justify-content:center; flex-wrap:wrap;">
                    ...
                    ${waBtn}
                    <span class="badge" style="background: rgba(16, 185, 129, 0.15); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.3); padding: 4px 8px; border-radius: 4px; font-size: 0.75rem;" title="Data Audit Terproteksi & Permanen"><i class="fa-solid fa-lock"></i> Audit</span>
                </div>
            </td>
        `;
        tbody.appendChild(tr);
