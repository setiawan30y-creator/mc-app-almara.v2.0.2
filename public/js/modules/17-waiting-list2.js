...
(function() {
            ...
            return `
                <tr style="border-bottom: 1px solid rgba(255,255,255,0.04);">
                    ...
                    <td style="padding: 12px;">
                        <a href="https://wa.me/${waPhone}" target="_blank" style="color: #25D366; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; font-weight: 600; font-size: 0.85rem;" title="Hubungi Nasabah via WhatsApp">
    ...
    window.sendWaitingListWhatsApp = function(id) {
    ...
    window.toggleWaitingListReady = function(id) {
        ...
        if (item) {
            ...
            if (confirm(`Antrean atas nama ${item.name} berhasil ditandai READY.\n\nApakah Anda ingin membuka WhatsApp untuk mengabari nasabah secara otomatis?`)) {
