                ...
                <section id="settings-view" class="view-section hidden">
                    ...
                    <div class="panel mt-4 settings-tab-content hidden" id="settings-tab-danger" style="display:none; border: 1px solid #ef4444;">
                        ...
                        <div class="mt-3" style="padding: 12px 14px; background: rgba(239, 68, 68, 0.08); border-left: 3px solid #ef4444; border-radius: 6px;">
                            <div style="font-weight: 600; margin-bottom: 8px;">Cakupan tombol reset:</div>
                            <div class="text-muted" style="line-height: 1.7;">
                                    Mengosongkan `Kas`, `Bank BCA`, `Bank Mandiri`, `stok valas`, `transaksi`, `mutasi`, `closing`, `nasabah`, `pengeluaran`, `penyesuaian`, `penanam saham`, `HRIS/karyawan`, `aset penyusutan`, `data koin/uang lama`, dan nomor invoice.
                                    Data `master kurs`, `master data`, `pengguna`, `profil perusahaan`, dan data referensi lain tetap dipertahankan.
                                </div>
                            </div>
                            <div class="d-flex gap-2 mt-4 flex-wrap">
                                ...
                                <button type="button" class="btn btn-danger" onclick="resetDatabase()"><i class="fa-solid fa-trash"></i> Reset Nominal dan Data Nasabah</button>
                            </div>
                        </div>
