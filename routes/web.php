...
Route::get('/', function () {
    ...
    // Denomination transaction bridge sementara dinonaktifkan.
    // Versi sebelumnya memasang MutationObserver yang memicu perubahan DOM
    // berulang pada select denominasi sehingga browser terus loading.
