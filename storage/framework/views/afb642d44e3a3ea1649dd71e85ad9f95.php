...
<body <?php if(strtolower((string) optional(auth()->user())->role) === 'papan'): ?> class="board-tv-mode" <?php endif; ?>>
    <script>
        const COMPANY_PROFILE = <?php echo json_encode($profile, 15, 512) ?>;
        const SERVER_BOARD_SETTINGS = <?php echo json_encode($papanSettings, 15, 512) ?>;
    </script>
    ...
    <main>
        ...
        <div class="btn-settings-trigger" id="boardSettingsTrigger" onclick="openSettingsModal()" title="Buka Pengaturan Monitor" <?php if(!in_array(strtolower((string) optional(auth()->user())->role), ['owner', 'superadmin'], true)): ?> style="display:none;" <?php endif; ?>>
    ...
    <!-- SCRIPTS -->
    <script>
        const CURRENT_BOARD_USER_ROLE = <?php echo json_encode(strtolower((string) optional(auth()->user())->role), 15, 512) ?>;
...
<?php /**PATH /var/www/mc-almara.v2/resources/views/papan-kurs.blade.php ENDPATH**/ ?>